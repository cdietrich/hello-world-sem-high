import { bG as et, cK as X, k3 as It, p0 as tt, hF as _, dB as ie, hk as Te, mm as At, E as q, dQ as it, zX as Pe, mn as Rt, zY as vt, n as rt, B as n, aP as Ne, au as Ve, bi as O, _ as x, a as d, ab as st, iA as Oe, b3 as xt, du as Lt, D, zZ as Ft, t2 as Ct, bn as yt, bm as He, tJ as Tt, dm as qe, z_ as Pt, oP as Nt, z$ as Ge, bD as Z, g as Vt, e as K, cx as De, c3 as Ke, I as Ot, cP as nt, hM as Dt, ag as We, zf as Kt, w as re, H as u, $ as f, tM as Wt, tN as Bt, S as Ut, cJ as Ht, b8 as we, b6 as ot, eW as at, za as lt, a0 as Ee, a2 as se, ax as ct, t as B, hK as L, jh as ht, oV as $e, A0 as qt, ll as Gt, A1 as $t, vm as zt, A2 as Qt, A3 as jt, dv as dt, at as Yt, kR as Xt, d as ze, pL as Jt, ey as ut, tC as Zt, L as T, p1 as Qe, af as ei, aL as mt, aI as ti, m4 as Be, bC as ii, h as ri, ad as si, aa as ni, ae as gt, dA as oi, tP as ai, iV as li, vk as ci, tU as hi, b4 as di, dj as ui, m9 as mi, zr as je, zs as be, cU as gi, dg as fi, wl as pi, dq as ki, dr as bi, c$ as Ye, aG as P, aR as wi, vI as Ei, vN as te, bx as ge, aE as A, fV as Q, N as fe, h$ as _i, ar as ft, k as pt, aA as Si, hP as Mi, ai as I, sV as R, A4 as ee, aj as kt, ak as Ii, yo as bt, cO as Ue, yp as wt, jl as Ai, aJ as Ri, o as vi, c4 as xi } from "./index-4c11c534.js";
import { a as b, M as a } from "./markers-9b18d66c.js";
function Et(l, e) {
    ...
    for (const [i, r] of e) {
      ...
      if (tt(r)) {
        ...
        const c = /* @__PURE__ */ new Map(), m = r.map((g) => {
          ...
          let k;
          return g.relatedInformation && (k = g.relatedInformation.map((F, pe) => new H(this.id(S, F.resource.toString(), F.startLineNumber, F.startColumn, F.endLineNumber, F.endColumn, pe), g, F))), new w(S, g, k);
        });
...
const C = class C extends Ne {
  ...
  constructor(e) {
    super(C.ID, p.MARKERS_PANEL_ACTION_TOOLTIP_QUICKFIX, C.CLASS, !1), this.marker = e, this._onShowQuickFixes = this._register(new q()), this.onShowQuickFixes = this._onShowQuickFixes.event, this._quickFixes = [];
  }
  run() {
...
let v = j, _e = class {
  ...
  getAriaLabel(e) {
    if (e instanceof y) {
      ...
      return p.MARKERS_TREE_ARIA_LABEL_RESOURCE(e.markers.length, e.name, Kt(t));
    }
    return e instanceof w || e instanceof V ? p.MARKERS_TREE_ARIA_LABEL_MARKER(e) : e instanceof H ? p.MARKERS_TREE_ARIA_LABEL_RELATED_INFORMATION(e.raw) : null;
  }
};
_e = x([
  d(0, Z)
...
let oe = Y, Se = class {
  ...
  renderTemplate(e) {
    const t = u(e, f(".resource-label-container")), i = this.labels.create(t, { supportHighlights: !0 }), r = u(e, f(".count-badge-wrapper"));
...
class Vi extends D {
  constructor(e, t, i, r) {
    super(), this.parent = e, this.markersViewModel = t, this._openerService = i, this.disposables = this._register(new re()), this.actionBar = this._register(new we(u(e, f(".actions")), {
      actionViewItemProvider: (s) => s.id === J.ID ? r.createInstance(ne, s) : void 0
    })), this.iconContainer = u(e, f("")), this.icon = u(this.iconContainer, f("")), this.messageAndDetailsContainer = u(e, f(".marker-message-details-container"));
  }
  render(e, t) {
  ...
  renderMultilineActionbar(e, t) {
    const i = this.disposables.add(new we(u(t, f(".multiline-actions")), {
  ...
  renderMessageAndDetails(e, t) {
    ...
    for (let g = 0; g < (o ? r.length : 1); g++) {
      const E = u(this.messageAndDetailsContainer, f(".marker-message-line")), M = u(E, f(".marker-message"));
  ...
  renderDetails(e, t, i) {
    if (i.classList.add("details-container"), e.source || e.code) {
      const s = new L(u(i, f(".marker-source"))), o = t && t.sourceMatches || [];
      if (s.set(e.source, o), e.code)
        if (typeof e.code == "string") {
          const c = new L(u(i, f(".marker-code"))), m = t && t.codeMatches || [];
          c.set(e.code, m);
        } else {
          const c = f(".marker-code"), m = new L(c), g = e.code.target.toString(!0);
    ...
    const r = u(i, f("span.marker-line"));
    r.textContent = p.MARKERS_PANEL_AT_LINE_COL_NUMBER(e.startLineNumber, e.startColumn);
  }
}
let Ie = class {
  constructor(e) {
  ...
  renderTemplate(e) {
    const t = /* @__PURE__ */ Object.create(null);
    u(e, f(".actions")), u(e, f(".icon")), t.resourceLabel = new L(u(e, f(".related-info-resource"))), t.lnCol = u(e, f("span.marker-line"));
    const i = u(e, f("span.related-info-resource-separator"));
    return i.textContent = ":", i.style.paddingRight = "4px", t.description = new L(u(e, f(".marker-description"))), t;
  }
  renderElement(e, t, i) {
    const r = e.element.raw, s = e.filterData && e.filterData.uriMatches || [], o = e.filterData && e.filterData.messageMatches || [];
    i.resourceLabel.set(X(r.resource), s), i.resourceLabel.element.title = this.labelService.getUriLabel(r.resource, { relative: !0 }), i.lnCol.textContent = p.MARKERS_PANEL_AT_LINE_COL_NUMBER(r.startLineNumber, r.startColumn), i.description.set(r.message, o), i.description.element.title = r.message;
  }
  disposeTemplate(e) {
  }
};
...
let he = (z = class {
  ...
  renderElement(e, t, i, r) {
    const s = p.MARKERS_PANEL_AT_LINE_COL_NUMBER(e.marker.startLineNumber, e.marker.startColumn);
...
let Le = class extends ai {
  ...
  renderBody(e) {
    ...
    const t = u(e, f(".markers-panel-container"));
    this.createArialLabelElement(t), this.createMessageBox(t), this.widgetContainer = u(t, f(".widget-container")), this.createWidget(this.widgetContainer), this.updateFilter(), this.renderContent();
  }
  getTitle() {
    return p.MARKERS_PANEL_TITLE_PROBLEMS;
  }
  ...
  createMessageBox(e) {
    this.messageBoxContainer = u(e, f(".message-box-container")), this.messageBoxContainer.setAttribute("aria-labelledby", "markers-panel-arialabel");
  }
  createArialLabelElement(e) {
    this.ariaLabelElement = u(e, f("")), this.ariaLabelElement.setAttribute("id", "markers-panel-arialabel");
  }
  createWidget(e) {
  ...
  createTable(e) {
    return this.instantiationService.createInstance(xe, u(e, f(".markers-table-container")), this.markersViewModel, this.getResourceMarkers(), this.filter.options, {
  ...
  createTree(e) {
    const t = new gi(), i = this.instantiationService.createInstance(fi, this), r = new oe(this.markersViewModel), s = [
    ...
    ], o = this.instantiationService.createInstance(Fe, "MarkersView", u(e, f(".tree-container.show-file-icons")), r, s, {
      filter: this.filter,
      accessibilityProvider: this.widgetAccessibilityProvider,
      identityProvider: this.widgetIdentityProvider,
  ...
  reInitialize() {
    ...
    return this.markersModel.setResourceMarkers(pi(t(), Et).map((i) => [i[0].resource, i])), e.push(T.debounce(this.markerService.onMarkerChanged, (i, r) => (i = i || new et(), r.forEach((s) => i.set(s, s)), i), 64)((i) => {
  ...
  renderFilteredByFilterMessage(e) {
    const t = u(e, f("span"));
    t.textContent = p.MARKERS_PANEL_NO_PROBLEMS_FILTERS;
    const i = u(e, f("a.messageAction"));
    ...
    }), this.setAriaLabel(p.MARKERS_PANEL_NO_PROBLEMS_FILTERS);
  }
  renderNoProblemsMessageForActiveFile(e) {
    const t = u(e, f("span"));
    t.textContent = p.MARKERS_PANEL_NO_PROBLEMS_ACTIVE_FILE_BUILT, this.setAriaLabel(p.MARKERS_PANEL_NO_PROBLEMS_ACTIVE_FILE_BUILT);
  }
  renderNoProblemsMessage(e) {
    const t = u(e, f("span"));
    t.textContent = p.MARKERS_PANEL_NO_PROBLEMS_BUILT, this.setAriaLabel(p.MARKERS_PANEL_NO_PROBLEMS_BUILT);
  }
  setAriaLabel(e) {
...
fe.as(_i.Configuration).registerConfiguration({
  id: "problems",
  order: 101,
  title: p.PROBLEMS_PANEL_CONFIGURATION_TITLE,
  type: "object",
  properties: {
    "problems.autoReveal": {
      description: p.PROBLEMS_PANEL_CONFIGURATION_AUTO_REVEAL,
      type: "boolean",
      default: !0
    },
    "problems.defaultViewMode": {
      description: p.PROBLEMS_PANEL_CONFIGURATION_VIEW_MODE,
      type: "string",
      default: "tree",
      enum: ["table", "tree"]
    },
    "problems.showCurrentInStatus": {
      description: p.PROBLEMS_PANEL_CONFIGURATION_SHOW_CURRENT_STATUS,
      type: "boolean",
      default: !1
    },
    "problems.sortOrder": {
      description: p.PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER,
      type: "string",
      default: "severity",
      enum: ["severity", "position"],
      enumDescriptions: [
        p.PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER_SEVERITY,
        p.PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER_POSITION
      ]
    }
  }
});
const St = Ke("markers-view-icon", O.warning, n("markersViewIcon", "View icon of the markers view.")), Di = fe.as(ft.ViewContainersRegistry).registerViewContainer({
  id: a.MARKERS_CONTAINER_ID,
  title: p.MARKERS_PANEL_TITLE_PROBLEMS,
  icon: St,
  hideIfEmpty: !0,
  order: 0,
  ctorDescriptor: new pt(
    Si,
...
fe.as(ft.ViewsRegistry).registerViews([{
  id: a.MARKERS_VIEW_ID,
  containerIcon: St,
  name: p.MARKERS_PANEL_TITLE_PROBLEMS,
  canToggleVisibility: !1,
  canMoveView: !0,
  ctorDescriptor: new pt(Le),
...
I(class extends kt {
  constructor() {
    super({
      ...
      title: { value: p.MARKERS_PANEL_SHOW_LABEL, original: "Focus Problems (Errors, Warnings, Infos)" },
      category: Ii.View,
      f1: !0
    });
  }
...
I(class extends kt {
  constructor() {
    super({
      ...
      title: p.MARKERS_PANEL_TOGGLE_LABEL
    });
  }
  async run(l) {
    const e = l.get(Q);
