import { D as O, $ as S, G as Fe, B as d, oE as Pe, oF as De, a0 as R, a2 as Be, b6 as Ce, lX as Ae, oG as Ee, oH as Ie, b3 as B, b4 as te, b9 as ie, au as x, bi as F, b8 as We, aP as Te, x as Ue, bf as Le, fi as Re, e0 as ue, oI as Ne, cB as Oe, eW as W, w as _e, lY as He, oJ as Me, kQ as qe, oK as Ve, _ as T, a as c, aX as _, l8 as fe, ad as Y, e as G, aU as me, cO as ge, oL as Ke, bF as Z, N as $e, hP as je, E as M, f2 as ze, an as ee, aH as Xe, g as pe, bB as Qe, bD as Se, bC as ve, a9 as Je, f0 as U, I as Ye, bE as be, oM as Ge, eC as ye, ag as Ze, bV as et, S as g, cP as ke, cK as b, ao as D, m9 as tt, U as se, mq as we, fb as I, cJ as v, kW as it, oN as k, oO as E, oP as st, oQ as ae, oR as P, oS as oe, at as ne, oT as H, oU as at, oV as ot, oW as nt, bJ as re, bK as rt, d as lt, bv as ht, lA as ct, aL as dt, cx as ut, bA as ft, bW as mt, gl as gt, jy as pt, kL as St, oX as vt, fq as bt, oY as yt, eU as le, oZ as kt, av as he, fz as wt, o_ as N, o$ as xt, k as ce, lq as Ft, lJ as Pt } from "./index-4c11c534.js";
import { i as Dt, b as Bt } from "./window-53e3628e.js";
...
const It = new Xe("remoteFileDialogVisible", !1);
let Q = class {
  ...
  async pickResource(e = !1) {
    ...
    return new Promise((a) => {
      if (this.filePickBox = this.quickInputService.createQuickPick(), this.busy = !0, this.filePickBox.matchOnLabel = !1, this.filePickBox.sortByLabel = !1, this.filePickBox.autoFocusOnList = !1, this.filePickBox.ignoreFocusOut = !0, this.filePickBox.ok = !0, this.scheme !== g.file && this.options && this.options.availableFileSystems && this.options.availableFileSystems.length > 1 && this.options.availableFileSystems.indexOf(g.file) > -1) {
        ...
        let r;
        e ? r = j : r = this.allowFileSelection ? this.allowFolderSelection ? X : $ : z;
      ...
      function n(r, h) {
        h && (h = P(h, r.separator), h = H(h)), a(h), r.contextKey.set(!1), r.filePickBox.dispose(), lt(r.disposables);
      }
  ...
  async tryUpdateItems(e, t) {
    if (e.length > 0 && e[0] === "~") {
      ...
      if (!E.isEqual(this.currentFolder, t) && (this.endsWithSlash(e) || !E.isEqual(this.currentFolder, v(t)) && E.isEqualOrParent(this.currentFolder, v(t)))) {
        ...
        {
          let s = v(t);
          const a = H(P(this.currentFolder)), o = H(P(s));
