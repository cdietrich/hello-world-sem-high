import { cT as Q, eM as Me, pj as Ae, pk as Pt, pl as Ot, pm as Lt, pn as Ht, po as Mt, pp as At, pq as Ft, pr as Nt, ps as $t, pt as jt, pu as Ut, pv as Gt, pw as qt, N as se, px as zt, ap as J, py as Ie, pz as Ze, pA as pe, pB as Bt, pC as Vt, pD as le, pE as Wt, pF as Xe, pG as F, is as k, pH as ke, pI as we, pJ as xe, pK as Kt, pL as je, fb as Jt, pM as Ue, B as r, pN as Ge, pO as qe, ao as Y, cJ as be, c9 as D, pP as de, pQ as Yt, pR as Zt, pS as ze, c5 as ue, pT as Be, pU as yt, iX as Ve, pV as Ee, E as ge, pW as Qe, h$ as Xt, bR as Ct, pX as v, pY as y, pZ as et, au as tt, p_ as Qt, p$ as en, _ as tn, a as L, ah as nn, aa as on, aL as sn, aI as rn, q0 as an, g as cn, q1 as hn, ac as ln, aX as dn, q2 as un, q3 as fn, bE as mn, q4 as _e, q5 as pn, q6 as gn, d7 as Tn, d0 as yn, q7 as Cn, bc as Sn, kH as In, q8 as bn, q9 as nt, at as En, d as ot, qa as kn, ae as wn, k as xn } from "./index-4c11c534.js";
const Fe = {};
function R(s, e) {
  let t = Fe[s];
  t || (Fe[s] = t = []), t.push(e);
...
const Gn = "vscode://schemas/icon-theme", qn = {
  type: "object",
  allowComments: !0,
  allowTrailingCommas: !0,
  definitions: {
...
function zn() {
  se.as(ze.JSONContribution).registerSchema(Gn, qn);
}
const H = class H {
  constructor(e, t, n) {
  ...
  loadIconThemeDocument(e) {
    return this.fileService.readExtensionResource(e).then((t) => {
      ...
      return n.length > 0 ? Promise.reject(new Error(r(
        ...
        n.map((i) => Ge(i.error)).join(", ")
      ))) : qe(o) !== "object" ? Promise.reject(new Error(r(
        "error.invalidformat",
...
const eo = {
  ...
  markdownDescription: r(
    ...
    q(y.PREFERRED_DARK_THEME),
    q(y.PREFERRED_LIGHT_THEME)
  ),
  default: !1
}, Et = {
  type: "object",
  ...
  markdownDescription: r(
    ...
    q(y.PREFERRED_HC_DARK_THEME),
    q(y.PREFERRED_HC_LIGHT_THEME)
  ),
  scope: 1
}, ve = {
  id: "workbench",
  ...
  properties: {
    ...
    semanticHighlighting: {
      ...
      markdownDeprecationMessage: r(
        ...
        q("editor.semanticTokenColorCustomizations")
      ),
      type: "boolean"
    }
  },
...
let $e = class {
  constructor(e, t, n, o, i, a, c, l, u, f, p, C) {
    ...
    let d = G.fromStorageData(this.storageService);
    ...
    if (T && (d == null ? void 0 : d.type) !== T && this.storageService.get(ce, he) !== T && (d = G.createUnloadedThemeForThemeType(T, void 0)), !d) {
      const O = (z = i.options) == null ? void 0 : z.initialColorTheme;
      O && (d = G.createUnloadedThemeForThemeType(O.themeType, O.colors ?? S));
    }
    d || (d = G.createUnloadedThemeForThemeType(Ct ? k.LIGHT : k.DARK, S)), d.setCustomizations(this.settings), this.applyTheme(d, void 0, !0);
